...
Use these gates only for evidence-bearing work that advances a project claim,
executes an authorized workflow, or creates a formal deliverable. Advisory
questions, read-only diagnosis, qualitative comparison, and preliminary
screening do not require a ledger and must not change gate state.
...
| layout/tapeout claim | circuit plus G5 |
